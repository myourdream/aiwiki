...
关于熵, 条件熵, 互信息, 这些内容在[第五章](../CH05/README.md)5.2节有对应的描述.
...
1. **互信息**
   ...
   一般的，熵$H(Y)$与条件熵$H(Y|X)$之差称为互信息。注意一下，这里[第五章](../CH05/README.md)中用到了$H(D, A)$ 可以对应理解下。
...
1. **相对熵 (KL 散度)** 
   ...
   注意这里，参考下[第五章](../CH05/README.md)中关于互信息的描述
